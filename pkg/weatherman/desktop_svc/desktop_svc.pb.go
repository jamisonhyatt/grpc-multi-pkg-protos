...
func (*GetWeatherRequest) Descriptor() ([]byte, []int) { return fileDescriptorDesktopSvc, []int{0} }
...
func (*GetWeatherResponse) Descriptor() ([]byte, []int) { return fileDescriptorDesktopSvc, []int{1} }
...
func init() { proto.RegisterFile("desktop_svc.proto", fileDescriptorDesktopSvc) }

var fileDescriptorDesktopSvc = []byte{
